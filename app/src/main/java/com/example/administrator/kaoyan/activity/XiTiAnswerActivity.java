...
import com.example.administrator.kaoyan.bean.MyEventBus2;
import com.example.administrator.kaoyan.bean.TestItem;
import com.example.administrator.kaoyan.config.Config;
...
public class XiTiAnswerActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, XiTiTestFragment.FragmentCallBack {
    ...
    public String tableName, sqLitePath, cuosqLitePath, title;//哪个表
    ...
    public int currectNums=0;//统计做题连对的次数
    ...
    private void initData() {
        mSharedPreferences=getSharedPreferences(Config.XITINAME,MODE_PRIVATE);
