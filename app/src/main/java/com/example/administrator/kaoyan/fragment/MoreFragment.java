...
import com.example.administrator.kaoyan.signcalendar.SignCalendarActivity;
...
public class MoreFragment extends Fragment implements View.OnClickListener {
    ...
    private void initView() {
        ...
        lin_qiandao = (LinearLayout) view.findViewById(R.id.lin_qiandao);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lin_remind:
                ...
                break;
            case R.id.lin_qiandao:
                Intent intentQiandao = new Intent(mainActivity, SignCalendarActivity.class);
